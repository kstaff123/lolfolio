          ...
          <div className="flex items-center sm:mt-2 mt-1 sm:mb-4 mb-2">
            ...
            <div className="flex flex-col ml-2 w-full">
              <div className="flex justify-between w-full">
                ...
                <h2 className="text-2xs sm:text-base font-thin ">{profile.flexgames !== undefined && `${profile.flexgames} games`}</h2>
              </div>
              <div className="flex justify-between w-full">
                <h2 className="text-2xs sm:text-base font-thin">{profile.flexlp !== undefined && `${profile.flexlp} LP`}</h2>
                <h2 className="text-2xs sm:text-base font-thin ">{profile.flexwinrate !== undefined && `${profile.flexwinrate}% winrate`}</h2>
              </div>
            </div>
          </div>
        </div>
